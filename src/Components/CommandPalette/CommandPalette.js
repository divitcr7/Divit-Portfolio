...
const commands = [
  ...
  { id: 'education', label: 'Go to Education', action: () => scrollToSection('education'), icon: 'bi-mortarboard' },
  { id: 'skills', label: 'Go to Skills', action: () => scrollToSection('skills'), icon: 'bi-gear' },
